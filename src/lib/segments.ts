...
export const segments: Segment[] = [
  {
    ...
    whyItMatters: [
      ...
      "Carta isn't a generic legal AI vendor bolting a chatbot onto a document template. It already sits inside the client relationship, holding the cap table and fund administration data that most PE/VC legal work is built around, and owning both the data and the drafting layer is what makes routine, template-driven work cheap to automate here.",
      "The work most exposed to this kind of vertical integration is exactly the standardised, high-volume drafting that has traditionally trained junior associates at firms serving fund clients: fund formation documents, side letters, NDAs, standard financing terms. That doesn't kill the law firm model. It squeezes the economics of the layer junior lawyers actually cut their teeth on.",
    ],
    takeaway:
      "Watch for more alternative business structures entering legal services from adjacent software platforms. The ones that already hold a client's underlying data start with a real advantage. For your own trajectory, the defensible ground is judgment-heavy negotiation and bespoke structuring, not document assembly.",
  },
  {
    slug: "thomson-reuters-ross-intelligence-fair-use",
    title: "Training an AI on Westlaw headnotes was not fair use",
    dek: "The first major US ruling on AI training data and copyright went against the AI company, and the reasoning behind it is still shaping how legal AI vendors source their data.",
    category: "regulatory",
    date: "2025-02-11",
    ...
    whyItMatters: [
      ...
      "Ross's tool never spat out Westlaw's original text verbatim, and that turned out not to matter much. What decided the case was that Ross's use was commercial and aimed at building a product that would compete directly in Westlaw's own market. That market-substitution effect broke the transformative-use argument even though the underlying technology looked genuinely novel.",
      "Every legal AI vendor building or buying data since has had to take that distinction seriously. It's part of why offerings like Carta Law lean on data the company already owns or has properly licensed rather than scraped secondary sources, and why Anthropic ultimately settled a similar training-data theory (see the next segment) rather than put it to a jury.",
    ],
    takeaway:
  ...
  },
  {
    ...
    whyItMatters: [
      "For years, 'what happens if we get sued over AI training data' was a theoretical risk clients asked about in the abstract. This settlement turns it into a concrete number (roughly $3,000 per work here) that in-house counsel and dealmakers can actually plug into risk assessments and indemnity negotiations with AI vendors.",
    ...
    takeaway:
      "When reviewing or negotiating an AI vendor contract, ask specifically how the training data was sourced and what indemnity applies if that sourcing turns out to be unlawful. This settlement is now the reference point opposing counsel will cite on both sides of that negotiation.",
  },
  {
    ...
    whyItMatters: [
      ...
      "This lands directly on M&A and IP due diligence: when you're diligencing a target whose product or content library was built substantially with generative AI, you now need to ask how much human authorship went into each asset, because part of the 'IP portfolio' on the balance sheet might not be protectable at all.",
  ...
  },
  {
    ...
    whyItMatters: [
      "In-house legal departments are increasingly willing to move work away from firms that can't demonstrate clear AI-enabled efficiency within about a year. That pressure squeezes fee margins right as the tooling, data infrastructure and AI-literate hiring needed to respond gets more expensive, and scale is one of the few ways to absorb that cost without cutting directly into partner profits.",
    ...
    takeaway:
      "Mid-size firm consolidation isn't likely to slow down through 2026 and 2027; the fixed cost of competing on AI tooling and talent keeps pushing firms toward scale. Worth factoring in if you're weighing firm size and practice group when you choose where to train.",
  },
  {
    ...
    whyItMatters: [
      "Kumar wasn't a junior associate quietly leaning on AI for background research. He put fabricated citations directly in front of his own regulator, twice, and that repetition is why the tribunal treated it as an aggravating pattern rather than a one-off slip.",
